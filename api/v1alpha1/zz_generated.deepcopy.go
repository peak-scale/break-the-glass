...
func (in *AccessRequestStatus) DeepCopyInto(out *AccessRequestStatus) {
	*out = *in
	out.ActiveFrom = in.ActiveFrom
	out.ActiveUntil = in.ActiveUntil
	out.KeepUntil = in.KeepUntil
	out.Duration = in.Duration
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessRuleAllowedRole) DeepCopyInto(out *AccessRuleAllowedRole) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessRuleAllowedRole.
func (in *AccessRuleAllowedRole) DeepCopy() *AccessRuleAllowedRole {
	if in == nil {
		return nil
	}
	out := new(AccessRuleAllowedRole)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AccessRuleSpec) DeepCopyInto(out *AccessRuleSpec) {
	*out = *in
	...
	out.KeepDuration = in.KeepDuration
	if in.Subjects != nil {
	...
	if in.AllowedRoles != nil {
		in, out := &in.AllowedRoles, &out.AllowedRoles
		*out = make([]AccessRuleAllowedRole, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}

...
// +kubebuilder:rbac:groups=addons.projectcapsule.dev,resources=accessrequests,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=addons.projectcapsule.dev,resources=accessrequests/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=addons.projectcapsule.dev,resources=accessrequests/finalizers,verbs=update
